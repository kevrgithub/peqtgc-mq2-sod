...
// The mandatory pre-setup function.  Our name is "ISXEQEQBH", and the class is ISXEQEQBH.
...
// our instanced class.
ISXPreSetup("ISXEQEQBH",ISXEQEQBH);
...
bool ISXEQEQBH::Initialize(ISInterface *p_ISInterface)
{	pISInterface=p_ISInterface;
	...
	WriteChatf("ISXEQEQBH Loaded");
	return true;
}

// shutdown sequence
void ISXEQEQBH::Shutdown()
{
	// save settings, if you changed them and want to save them now.  You should normally save
	// changes immediately.
	//pISInterface->ExportSet(ISXEQEQBHXML,XMLFileName);

	pISInterface->UnloadSet(ISXEQEQBHXML);
...
void ISXEQEQBH::ConnectServices()
{
...
void ISXEQEQBH::RegisterCommands()
{
	// add any commands
...
void ISXEQEQBH::RegisterAliases()
{
	// add any aliases
}

void ISXEQEQBH::RegisterDataTypes()
{
	// add any datatypes
	// pMyType = new MyType;
...
void ISXEQEQBH::UnRegisterCommands()
{
	// remove commands
//	pISInterface->RemoveCommand("MyCommand");
}
void ISXEQEQBH::UnRegisterAliases()
{
	// remove aliases
}
void ISXEQEQBH::UnRegisterDataTypes()
{
	// remove data types
	//if (pMyType)
	//{
...
void ISXEQEQBH::UnRegisterTopLevelObjects()
{
	// remove Top-Level Objects
//	pISInterface->RemoveTopLevelObject("MapSpawn");
}
void ISXEQEQBH::UnRegisterServices()
{
	// shutdown our own services
//	if (hISXEQEQBHService)
//		pISInterface->ShutdownService(this,hISXEQEQBHService);
}

void ISXEQEQBH::LoadSettings()
{
	bool bChanged=false;

	// open the settings file, and store the ID number in ISXEQEQBHXML
	ISXEQEQBHXML=pISInterface->OpenSettings(XMLFileName);
...
Any set can be referred to by its ID.  The base set is stored in ISXEQEQBHXML.  Note that the settings
...
*/
	...
	if (unsigned int GeneralGUID=pISInterface->FindSet(ISXEQEQBHXML,"General"))
	{
