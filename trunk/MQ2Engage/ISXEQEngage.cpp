...
#include "ISXEQEngage.h"

// The mandatory pre-setup function.  Our name is "ISXEQEngage", and the class is ISXEQEngage.
...
// our instanced class.
ISXPreSetup("ISXEQEngage",ISXEQEngage);
...
bool ISXEQEngage::Initialize(ISInterface *p_ISInterface)
{	pISInterface=p_ISInterface;
	...
	WriteChatf("ISXEQEngage Loaded");
	return true;
}

// shutdown sequence
void ISXEQEngage::Shutdown()
{
	// save settings, if you changed them and want to save them now.  You should normally save
	// changes immediately.
	//pISInterface->ExportSet(ISXEQEngageXML,XMLFileName);

	pISInterface->UnloadSet(ISXEQEngageXML);
...
void ISXEQEngage::ConnectServices()
{
...
void ISXEQEngage::RegisterCommands()
{
	// add any commands
...
void ISXEQEngage::RegisterAliases()
{
	// add any aliases
}

void ISXEQEngage::RegisterDataTypes()
{
	// add any datatypes
	// pMyType = new MyType;
...
void ISXEQEngage::UnRegisterCommands()
{
	// remove commands
//	pISInterface->RemoveCommand("MyCommand");
}
void ISXEQEngage::UnRegisterAliases()
{
	// remove aliases
}
void ISXEQEngage::UnRegisterDataTypes()
{
	// remove data types
	//if (pMyType)
	//{
...
void ISXEQEngage::UnRegisterTopLevelObjects()
{
	// remove Top-Level Objects
//	pISInterface->RemoveTopLevelObject("MapSpawn");
}
void ISXEQEngage::UnRegisterServices()
{
	// shutdown our own services
//	if (hISXEQEngageService)
//		pISInterface->ShutdownService(this,hISXEQEngageService);
}

void ISXEQEngage::LoadSettings()
{
	bool bChanged=false;

	// open the settings file, and store the ID number in ISXEQEngageXML
	ISXEQEngageXML=pISInterface->OpenSettings(XMLFileName);
...
Any set can be referred to by its ID.  The base set is stored in ISXEQEngageXML.  Note that the settings
...
*/
	...
	if (unsigned int GeneralGUID=pISInterface->FindSet(ISXEQEngageXML,"General"))
	{
