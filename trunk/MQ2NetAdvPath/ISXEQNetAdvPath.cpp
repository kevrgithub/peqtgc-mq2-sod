...
#include "ISXEQNetAdvPath.h"

// The mandatory pre-setup function.  Our name is "ISXEQNetAdvPath", and the class is ISXEQNetAdvPath.
...
// our instanced class.
ISXPreSetup("ISXEQNetAdvPath",ISXEQNetAdvPath);
...
bool ISXEQNetAdvPath::Initialize(ISInterface *p_ISInterface)
{	pISInterface=p_ISInterface;
	...
	WriteChatf("ISXEQNetAdvPath Loaded");
	return true;
}

// shutdown sequence
void ISXEQNetAdvPath::Shutdown()
{
...
void ISXEQNetAdvPath::ConnectServices()
{
...
void ISXEQNetAdvPath::RegisterCommands()
{
	// add any commands
...
void ISXEQNetAdvPath::RegisterAliases()
{
	// add any aliases
}

void ISXEQNetAdvPath::RegisterDataTypes()
{
	// add any datatypes
	// pMyType = new MyType;
...
void ISXEQNetAdvPath::UnRegisterCommands()
{
	// remove commands
//	pISInterface->RemoveCommand("MyCommand");
}
void ISXEQNetAdvPath::UnRegisterAliases()
{
	// remove aliases
}
void ISXEQNetAdvPath::UnRegisterDataTypes()
{
	// remove data types
	//if (pMyType)
	//{
...
void ISXEQNetAdvPath::UnRegisterTopLevelObjects()
{
	// remove Top-Level Objects
//	pISInterface->RemoveTopLevelObject("MapSpawn");
}
void ISXEQNetAdvPath::UnRegisterServices()
{
	// shutdown our own services
//	if (hISXEQNetAdvPathService)
//		pISInterface->ShutdownService(this,hISXEQNetAdvPathService);
}

void ISXEQNetAdvPath::LoadSettings()
{
	...
	if (!pISInterface->GetSetting(XMLFileName,"My Section","My String Setting",StringSetting,sizeof(StringSetting)))
	{
		...
		// Let's set it to a new default, "ISXEQNetAdvPath", and store it.
		strcpy(StringSetting,"ISXEQNetAdvPath");
