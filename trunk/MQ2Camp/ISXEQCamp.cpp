...
// The mandatory pre-setup function.  Our name is "ISXEQCamp", and the class is ISXEQCamp.
...
// our instanced class.
ISXPreSetup("ISXEQCamp",ISXEQCamp);
...
bool ISXEQCamp::Initialize(ISInterface *p_ISInterface)
{	pISInterface=p_ISInterface;
	...
	WriteChatf("ISXEQCamp Loaded");
	return true;
}

// shutdown sequence
void ISXEQCamp::Shutdown()
{
	// save settings, if you changed them and want to save them now.  You should normally save
	// changes immediately.
	//pISInterface->ExportSet(ISXEQCampXML,XMLFileName);

	pISInterface->UnloadSet(ISXEQCampXML);
...
void ISXEQCamp::ConnectServices()
{
...
void ISXEQCamp::RegisterCommands()
{
	// add any commands
...
void ISXEQCamp::RegisterAliases()
{
	// add any aliases
}

void ISXEQCamp::RegisterDataTypes()
{
	// add any datatypes
	// pMyType = new MyType;
...
void ISXEQCamp::UnRegisterCommands()
{
	// remove commands
//	pISInterface->RemoveCommand("MyCommand");
}
void ISXEQCamp::UnRegisterAliases()
{
	// remove aliases
}
void ISXEQCamp::UnRegisterDataTypes()
{
	// remove data types
	//if (pMyType)
	//{
...
void ISXEQCamp::UnRegisterTopLevelObjects()
{
	// remove Top-Level Objects
//	pISInterface->RemoveTopLevelObject("MapSpawn");
}
void ISXEQCamp::UnRegisterServices()
{
	// shutdown our own services
//	if (hISXEQCampService)
//		pISInterface->ShutdownService(this,hISXEQCampService);
}

void ISXEQCamp::LoadSettings()
{
	bool bChanged=false;

	// open the settings file, and store the ID number in ISXEQCampXML
	ISXEQCampXML=pISInterface->OpenSettings(XMLFileName);
...
Any set can be referred to by its ID.  The base set is stored in ISXEQCampXML.  Note that the settings
...
*/
	...
	if (unsigned int GeneralGUID=pISInterface->FindSet(ISXEQCampXML,"General"))
	{
