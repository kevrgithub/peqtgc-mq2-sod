...
// The mandatory pre-setup function.  Our name is "ISXEQDps", and the class is ISXEQDps.
...
bool ISXEQDps::Initialize(ISInterface *p_ISInterface)
{	pISInterface=p_ISInterface;
	...
	WriteChatf("ISXEQDps Loaded");
	return true;
}

// shutdown sequence
void ISXEQDps::Shutdown()
{
...
void ISXEQDps::RegisterCommands()
{
	// add any commands
...
void ISXEQDps::RegisterAliases()
{
	// add any aliases
}

void ISXEQDps::RegisterDataTypes()
{
	// add any datatypes
	// pMyType = new MyType;
...
void ISXEQDps::UnRegisterCommands()
{
	// remove commands
//	pISInterface->RemoveCommand("MyCommand");
}
void ISXEQDps::UnRegisterAliases()
{
	// remove aliases
}
void ISXEQDps::UnRegisterDataTypes()
{
	// remove data types
	//if (pMyType)
	//{
...
void ISXEQDps::UnRegisterTopLevelObjects()
{
	// remove Top-Level Objects
//	pISInterface->RemoveTopLevelObject("MapSpawn");
}
void ISXEQDps::UnRegisterServices()
{
	// shutdown our own services
//	if (hISXEQDpsService)
//		pISInterface->ShutdownService(this,hISXEQDpsService);
}

void ISXEQDps::LoadSettings()
{
	...
	if (!pISInterface->GetSetting(XMLFileName,"My Section","My String Setting",StringSetting,sizeof(StringSetting)))
	{
		...
		// Let's set it to a new default, "ISXEQDps", and store it.
		strcpy(StringSetting,"ISXEQDps");
