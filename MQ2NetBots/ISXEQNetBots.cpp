...
#include "ISXEQNetBots.h"

// The mandatory pre-setup function.  Our name is "ISXEQNetBots", and the class is ISXEQNetBots.
...
// our instanced class.
ISXPreSetup("ISXEQNetBots",ISXEQNetBots);
...
bool ISXEQNetBots::Initialize(ISInterface *p_ISInterface)
{	pISInterface=p_ISInterface;
	...
	WriteChatf("ISXEQNetBots Loaded");
	return true;
}

// shutdown sequence
void ISXEQNetBots::Shutdown()
{
...
void ISXEQNetBots::ConnectServices()
{
...
void ISXEQNetBots::RegisterCommands()
{
	// add any commands
...
void ISXEQNetBots::RegisterAliases()
{
	// add any aliases
}

void ISXEQNetBots::RegisterDataTypes()
{
	// add any datatypes
	// pMyType = new MyType;
...
void ISXEQNetBots::UnRegisterCommands()
{
	// remove commands
//	pISInterface->RemoveCommand("MyCommand");
}
void ISXEQNetBots::UnRegisterAliases()
{
	// remove aliases
}
void ISXEQNetBots::UnRegisterDataTypes()
{
	// remove data types
	//if (pMyType)
	//{
...
void ISXEQNetBots::UnRegisterTopLevelObjects()
{
	// remove Top-Level Objects
//	pISInterface->RemoveTopLevelObject("MapSpawn");
}
void ISXEQNetBots::UnRegisterServices()
{
	// shutdown our own services
//	if (hISXEQNetBotsService)
//		pISInterface->ShutdownService(this,hISXEQNetBotsService);
}

void ISXEQNetBots::LoadSettings()
{
	...
	if (!pISInterface->GetSetting(XMLFileName,"My Section","My String Setting",StringSetting,sizeof(StringSetting)))
	{
		...
		// Let's set it to a new default, "ISXEQNetBots", and store it.
		strcpy(StringSetting,"ISXEQNetBots");
