...
// The mandatory pre-setup function.  Our name is "ISXEQTest", and the class is ISXEQTest.
...
// our instanced class.
ISXPreSetup("ISXEQTest",ISXEQTest);
...
bool ISXEQTest::Initialize(ISInterface *p_ISInterface)
{	pISInterface=p_ISInterface;
	...
	WriteChatf("ISXEQTest Loaded");
	return true;
}

// shutdown sequence
void ISXEQTest::Shutdown()
{
	// save settings, if you changed them and want to save them now.  You should normally save
	// changes immediately.
	//pISInterface->ExportSet(ISXEQTestXML,XMLFileName);

	pISInterface->UnloadSet(ISXEQTestXML);
...
void ISXEQTest::ConnectServices()
{
...
void ISXEQTest::RegisterCommands()
{
	// add any commands
...
void ISXEQTest::RegisterAliases()
{
	// add any aliases
}

void ISXEQTest::RegisterDataTypes()
{
	// add any datatypes
	// pMyType = new MyType;
...
void ISXEQTest::UnRegisterCommands()
{
	// remove commands
//	pISInterface->RemoveCommand("MyCommand");
}
void ISXEQTest::UnRegisterAliases()
{
	// remove aliases
}
void ISXEQTest::UnRegisterDataTypes()
{
	// remove data types
	//if (pMyType)
	//{
...
void ISXEQTest::UnRegisterTopLevelObjects()
{
	// remove Top-Level Objects
//	pISInterface->RemoveTopLevelObject("MapSpawn");
}
void ISXEQTest::UnRegisterServices()
{
	// shutdown our own services
//	if (hISXEQTestService)
//		pISInterface->ShutdownService(this,hISXEQTestService);
}

void ISXEQTest::LoadSettings()
{
	bool bChanged=false;

	// open the settings file, and store the ID number in ISXEQTestXML
	ISXEQTestXML=pISInterface->OpenSettings(XMLFileName);
...
Any set can be referred to by its ID.  The base set is stored in ISXEQTestXML.  Note that the settings
...
*/
	...
	if (unsigned int GeneralGUID=pISInterface->FindSet(ISXEQTestXML,"General"))
	{
