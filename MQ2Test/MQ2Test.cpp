...
{
	DebugSpewAlways("MQ2Test::OnZoned()");
}
...
{
	DebugSpewAlways("MQ2Test::OnCleanUI()");
...
{
	DebugSpewAlways("MQ2Test::OnReloadUI()");
...
//	DebugSpewAlways("MQ2Test::OnDrawHUD()");
}

// Called once directly after initialization, and then every time the gamestate changes
PLUGIN_API VOID SetGameState(DWORD GameState)
{
	DebugSpewAlways("MQ2Test::SetGameState()");
...
{
	// DONT leave in this debugspew, even if you leave in all the others
//	DebugSpewAlways("MQ2Test::OnPulse()");
}
...
{
	DebugSpewAlways("MQ2Test::OnWriteChatColor(%s)",Line);
	return 0;
}
...
{
	DebugSpewAlways("MQ2Test::OnIncomingChat(%s)",Line);
	return 0;
}
...
{
	DebugSpewAlways("MQ2Test::OnAddSpawn(%s)",pNewSpawn->Name);
}
...
{
	DebugSpewAlways("MQ2Test::OnRemoveSpawn(%s)",pSpawn->Name);
}
...
{
	DebugSpewAlways("MQ2Test::OnAddGroundItem(%d)",pNewGroundItem->DropID);
}
...
{
	DebugSpewAlways("MQ2Test::OnRemoveGroundItem(%d)",pGroundItem->DropID);
}
