# Microsoft Developer Studio Generated NMAKE File, Based on MQ2CastTimer.dsp
!IF "$(CFG)" == ""
CFG=MQ2CastTimer - Win32 Release
!MESSAGE No configuration specified. Defaulting to MQ2CastTimer - Win32 Release.
!ENDIF 

!IF "$(CFG)" != "MQ2CastTimer - Win32 Release"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "MQ2CastTimer.mak" CFG="MQ2CastTimer - Win32 Release"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "MQ2CastTimer - Win32 Release" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE 
...
ALL : "MQ2Main - Win32 Release" "macroquest - Win32 Release" "$(OUTDIR)\MQ2CastTimer.dll"
...
CPP=cl.exe
CPP_PROJ=/nologo /Zp1 /MT /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "CINTERFACE" /Fp"$(INTDIR)\MQ2CastTimer.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
RSC=rc.exe
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\MQ2CastTimer.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ..\Detours\lib60\detours.lib ..\Release\MQ2Main.lib /nologo /dll /incremental:no /pdb:"$(OUTDIR)\MQ2CastTimer.pdb" /machine:I386 /out:"$(OUTDIR)\MQ2CastTimer.dll" /implib:"$(OUTDIR)\MQ2CastTimer.lib" /OPT:ICF 
LINK32_OBJS= \
